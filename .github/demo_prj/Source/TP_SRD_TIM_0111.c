/*
 * TP_SRD_TIM_0111.c - High-level test procedure for Time Management
 *
...
/**
 * TestDo - prefroming test
 *
 * DESCRIPTION
 *   Test code to exercise if NEOS-178S stops a software timer in periodical 
 *   mode. 
 *
 * PARAMETERS
 *  N/A
 *
 * TRACEABILITY
 *  [TP_SRD_TIM_0111 -> TC_SRD_TIM_0111]
 *
 * RETURNS
 *  This routine returns SUCCESS if the test is passed successfully,
 *  or it returns ERROR to indicate the test error.
