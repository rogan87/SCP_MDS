/*
 * TP_SRD_TIM_0082.c - High-level test procedure for Time Management
 *
 ...
 *
 * DESCRIPTION
 *  Test code to exercise if NEOS-178S fails to start a software timer in 
 *  one-shot mode with zero timeout.
 *
 * PARAMETERS
 *  N/A
 *
 * TRACEABILITY
 *  [TP_SRD_TIM_0082 -> TC_SRD_TIM_0082]
 *
 * RETURNS
